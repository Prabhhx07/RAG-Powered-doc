...
export default function ChatPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const res = await apiAsk(q, parseInt(documentId, 10), history.slice(-3));
      const botMsg = {
        id: Date.now() + 1,
        role: "assistant",
        text: res.answer,
      ...
      <div className="chat-messages" id="chat-messages">
        {messages.length === 0 && !loading && (
          <div className="chat-empty">
            ...
            <p>
              DocMind will search through the document and answer your question.
            </p>
            ...
            <div className="message-bubble">
              ...
              {msg.role === "assistant" && msg.chunks != null && (
                <span className="message-meta">
                  Based on {msg.chunks} chunk{msg.chunks !== 1 ? "s" : ""}
                </span>
              )}
            </div>
            {msg.role === "user" && (
